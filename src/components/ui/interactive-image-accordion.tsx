...
export const defaultProjectsAccordionItems: ProjectAccordionItemData[] = [
  {
    ...
    description: "Cross-platform end-to-end encrypted (E2EE) messaging app built with Flutter & Supabase. Features zero-knowledge architecture, libsodium encryption, X25519 forward secrecy, and anonymous session mode without account registration.",
